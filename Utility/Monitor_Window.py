...
# =============================================================================
    ...
    def UpdateGraph(self):
        ...
        try:
            ...
            for x in range (0,8):#Temp A, Temp B and Temperatures 1-6 On the 218
                self.ax.plot(self.Time_Data,[el[x] for el in self.Temperature_Data])
...
def Controller(Pipe,TCon_add,Backup_TConAdd, TMon_add=None):
    ...
    while Abort == False:
        ...
        #print([time.time(),Current_TCon_VTI,Current_TCon_Sample,*Current_TMon,IsRamping,IsStable])
        time.sleep(0.25)
# =============================================================================
...
# =============================================================================
    ...
    # =============================================================================
                ...
                if Param == type(""):#check that we're not getting a float
        ...
        # =============================================================================
                        ...
                        print("Invalid String Command Seen IN Temp. Controller! Got"+Param)#debugging code fragment to delete
